    ...
    <div ref={rootRef} className="relative w-full max-w-2xl">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full min-h-12 pl-11 pr-20 rounded-2xl bg-white/90 backdrop-blur-md border border-slate-200/90 text-sm font-medium text-slate-900 placeholder:text-slate-400 shadow-sm outline-none focus:border-[#2C3B2E]/50 focus:ring-2 focus:ring-[#F0EFEA] transition-all"
        />
        {value.length > 0 ? (
          <button
            type="button"
                ...
                <li key={community.id} role="option" aria-selected={active}>
                  <button
                    ...
                    className={`w-full flex items-center gap-3 px-3 py-2.5 min-h-14 text-left transition-colors ${
                      active ? 'bg-[#F0EFEA]/70' : 'hover:bg-slate-50'
                    }`}
                  >
                    <div
                      className="w-10 h-10 rounded-xl overflow-hidden shrink-0 border border-slate-100 bg-gradient-to-br from-[#2C2621] to-[#2C3B2E]"
                    >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-0.5">
                        <span className="inline-flex items-center text-[10px] font-extrabold uppercase tracking-wider text-[#2C2621] bg-[#E6E3DB]/70 px-2 py-0.5 rounded-full">
