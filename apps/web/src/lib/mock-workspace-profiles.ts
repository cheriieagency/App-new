...
function buildProfiles(): WorkspaceProfile[] {
  const nordic = applyBioPreset('nordic');
  const dark = applyBioPreset('dark');
  ...
  return [
    {
      ...
      analytics: {
        ...
        event_rsvps: 22,
        products: 6,
        revenue_chart: [42, 58, 51, 72, 66, 88, 79],
        utm_links: labUtm,
        utm_total_clicks: labUtm.reduce((n, r) => n + r.clicks, 0),
        recent_emails: [
          {
            name: 'Emma Lindqvist',
      ...
      community: {
        ...
        active_moderators: 2,
        recent_members: [
          { id: 'seed-1', name: 'Emma Lindqvist', email: 'emma@example.com', role: 'moderator' },
          { id: 'seed-2', name: 'Marcus Björk', email: 'marcus@example.com', role: 'member' },
          { id: 'seed-3', name: 'Astrid Karlsson', email: 'astrid@example.com', role: 'member' },
        ],
      },
      email: {
        total_subscribers: 312,
        average_open_rate: 48.2,
        broadcasts_sent: 14,
        subscriber_preview: [
          { name: 'Emma Lindqvist', email: 'emma@example.com', source_label: 'E-Book' },
          { name: 'Marcus Björk', email: 'marcus@example.com', source_label: 'Bio Store' },
          { name: 'Noah Berg', email: 'noah@example.com', source_label: 'Community' },
        ],
      },
      planner: {
        kanban_count: 8,
    ...
    },
    {
      ...
      analytics: {
        ...
        event_rsvps: 41,
        products: 3,
        revenue_chart: [28, 35, 44, 39, 55, 62, 58],
        utm_links: liveUtm,
        utm_total_clicks: liveUtm.reduce((n, r) => n + r.clicks, 0),
        recent_emails: [
          {
            name: 'Sara Holm',
      ...
      community: {
        ...
        active_moderators: 1,
        recent_members: [
          { id: 'live-1', name: 'Sara Holm', email: 'sara@example.com', role: 'moderator' },
          { id: 'live-2', name: 'Johan Ek', email: 'johan@example.com', role: 'member' },
        ],
      },
      email: {
        total_subscribers: 186,
        average_open_rate: 56.8,
        broadcasts_sent: 9,
        subscriber_preview: [
          { name: 'Sara Holm', email: 'sara@example.com', source_label: 'Webinar' },
          { name: 'Johan Ek', email: 'johan@example.com', source_label: 'VIP' },
          { name: 'Lisa Ny', email: 'lisa@example.com', source_label: 'Bio Store' },
        ],
      },
      planner: {
        kanban_count: 5,
...
export function cloneProfile(p: WorkspaceProfile): WorkspaceProfile {
  return {
    ...
    analytics: {
      ...p.analytics,
      revenue_chart: [...p.analytics.revenue_chart],
