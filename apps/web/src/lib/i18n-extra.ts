...
export const EXTRA_EN: ExtraDict = {
  ...
  landingHeroHeadline: 'Build, Sell & Scale — Community, Bio & Social in One App',
  landingHeroSub:
    'Stop juggling Later, Linktree, Skool, Zoom and Stripe. Plan posts, tag products, run your link-in-bio, grow a community, host events, and take Nordic payments — all in one mobile-first creator platform.',
  ...
  suiteHeadline: 'Your Later-style command center',
  suiteSub:
    'Everything you use after login: brand Social Sets, media, inbox, analytics, tagging, bio, community and email — in one clean slate dashboard.',
  suitePlannerTitle: 'Calendar / Planner',
  suitePlannerSummary: 'Schedule and manage posts across your Social Set profiles.',
  suiteBioTitle: 'Bio Builder',
  suiteBioSummary: 'Blocks, Design themes, UTM analytics and link settings.',
  suiteAnalyticsTitle: 'Advanced Analytics',
  suiteAnalyticsSummary: 'Growth charts, post/reel/story stats and Linkin.bio clicks.',
  suiteTaggingTitle: 'Post Tagging & E-com',
  suiteTaggingSummary: 'Overlay product links and track every sale from content.',
  suiteMediaTitle: 'Media Library',
  suiteMediaSummary: 'Browse creatives and open tagged posts in one place.',
  suiteInboxTitle: 'Social Inbox',
  suiteInboxSummary: 'DMs and comments across Instagram & TikTok profiles.',
  suiteCommunityTitle: 'Community & Members',
  suiteCommunitySummary: 'Members, feed moderation, classroom, store and live.',
  suiteEmailTitle: 'Email CRM',
  suiteEmailSummary: 'Broadcasts, tags and engagement for every brand workspace.',
  ...
  joinForPrice: 'Join for $19.90/mo',
...
export const EXTRA_SV: ExtraDict = {
  ...
  suiteEyebrow: 'Creator Admin',
  suiteHeadline: 'Din Later-inspirerade kommandocentral',
  suiteSub:
    'Allt efter inloggning: Social Sets, media, inbox, analytics, tagging, bio, community och e-post — i en ren dashboard.',
  suitePlannerTitle: 'Kalender / Planner',
  suitePlannerSummary: 'Schemalägg och hantera inlägg över Social Set-profiler.',
  suiteBioTitle: 'Bio Builder',
  suiteBioSummary: 'Blocks, Design-teman, UTM-analytics och länkinställningar.',
  suiteAnalyticsTitle: 'Advanced Analytics',
  suiteAnalyticsSummary: 'Tillväxtgrafer, post/reel/story-statistik och Linkin.bio-klick.',
  suiteTaggingTitle: 'Post Tagging & E-com',
  suiteTaggingSummary: 'Lägg produktlänkar och spåra varje försäljning från content.',
  suiteMediaTitle: 'Media Library',
  suiteMediaSummary: 'Bläddra creatives och öppna taggade inlägg på ett ställe.',
  suiteInboxTitle: 'Social Inbox',
  suiteInboxSummary: 'DM:ar och kommentarer över Instagram & TikTok.',
  suiteCommunityTitle: 'Community & Members',
  suiteCommunitySummary: 'Medlemmar, feed-moderation, classroom, store och live.',
  suiteEmailTitle: 'E-post CRM',
  suiteEmailSummary: 'Utskick, taggar och engagemang för varje varumärkes-workspace.',
  ...
  catFinance: 'Ekonomi',
  catCoaching: 'Coaching',
  joinForPrice: 'Gå med för 19,90 $/mån',
...
export const EXTRA_BY_LOCALE: Record<ExtraLocale, ExtraDict> = {
  ...
  no: {
    ...
    suiteHeadline: 'Din Later-inspirerte kommandosentral',
  ...
  da: {
    ...
    suiteHeadline: 'Dit Later-inspirerede kommandocenter',
    ...
    suiteHeadline: 'Later-tyylinen komentokeskuksesi',
