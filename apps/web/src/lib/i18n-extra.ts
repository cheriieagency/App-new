...
landingHeroLine1: 'The All-in-One Creator Engine',
  ...
  footerBlurb: 'The Nordic all-in-one creator OS — social planning, bio storefront, community, and Swish checkout in one studio.',
...
landingHeroLine1: 'The All-in-One Creator Engine',
  ...
  footerLegal: 'Juridik',
  footerSupport: 'Support',
  footerBlurb: 'Det nordiska allt-i-ett creator-OS:et — social planering, bio-storefront, community och Swish-checkout i en studio.',
